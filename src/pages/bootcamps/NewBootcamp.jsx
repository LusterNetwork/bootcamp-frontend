...
import { NewBootCampCurriculum } from '../../components/bootcamp components'
    ...
    <main className='md:w-[90%] mx-auto'>
        ...
        <div className='pt-12 min-h-[95vh] flex flex-col items-center justify-center'>
            <div className='flex flex-col mb-4 md:mb-0 md:flex-row'>
                ...
                <span className='text-neutral-100 m-0'>Become a Blockchain Developer</span>
                {/* <span className='m-0'>Blockchain</span> */}
                </p>
            </div>
            <div>
                <p className='text-5xl md:text-[60px] m-0 md:mb-4 font-bold'> in 8 hours </p>
            </div>
            ...
            <div className="button md:mt-8 mt-4">
                <a href={"/newbootcampregister"} className='h-[4rem] text-3xl transform transition duration-500 hover:scale-125 my-2 flex font-semibold border-transparent rounded-lg items-center w-[15rem] bg-gradient-to-r from-[#58AFEF] to-[#9374DC]  justify-center '><button>Book now !</button></a>
            </div>
        </div>
        ...
        <section className='flex flex-col items-center md:flex-row md:justify-between md:flex-wrap px-8 py-8'>
            ...
            <div className="text-left md:w-[65%]">
                ...
                <div className='text-4xl md:text-5xl text-white font-semibold md:w-[75%]'>
                    <p>
                        <span className='md:leading-[5rem]'>Become a</span>
                        <span className=''> Blockchain Developer</span>
                        <span className=''> in 8 hours</span>
                ...
                <div className="button mt-4">
                    <a href="/newbootcampregister" className='h-[3rem] text-2xl transform transition duration-500 hover:scale-125 my-2 flex font-semibold border-transparent rounded-lg items-center w-[12rem] bg-gradient-to-r from-[#58AFEF] to-[#9374DC]  justify-center'><button>Book now !</button></a>
                </div>
        ...
        <section>
            <div className="grid grid-cols-1 px-4 md:px-0 md:grid-cols-2 min-h-[94vh]">
                ...
                <div className="col-span-1 place-self-center">
                    ...
                    <Link to='/newbootcampregister' className='h-[4rem] text-3xl transform transition duration-500 hover:scale-105 my-2 flex font-semibold border-transparent rounded-lg items-center w-[15rem] bg-gradient-to-r from-[#58AFEF] to-[#9374DC]  justify-center'>
                        Book now!
                    </Link>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <div className='flex flex-col gap-12 my-15 items-center justify-center'>
                    ...
                    <div className='items-center shadow-md  bg-gradient-to-r from-[#58AFEF] to-[#9374DC] rounded-[15px] py-8 pt-8 px-8'>
                        <div className='text-3xl md:text-7xl font-bold mb-1 '>₹499 Only</div>
