    ...
    <main className='md:w-[90%] mx-auto'>
        ...
        <div className='pt-12 min-h-[95vh] flex flex-col items-center justify-center'>
            ...
            <div className="button md:mt-8 mt-4">
                <a href={"/register"} className='h-[4rem] text-3xl transform transition duration-500 hover:scale-125 my-2 flex font-semibold border-transparent rounded-lg items-center w-[15rem] bg-gradient-to-r from-[#58AFEF] to-[#9374DC]  justify-center '><button>Book now !</button></a>
            </div>
        </div>
        ...
        <section className='flex flex-col items-center md:flex-row md:justify-between md:flex-wrap px-8 py-8'>
            ...
            <div className="text-left md:w-[65%]">
                ...
                <div className="button mt-4">
                    <a href="/register" className='h-[3rem] text-2xl transform transition duration-500 hover:scale-125 my-2 flex font-semibold border-transparent rounded-lg items-center w-[12rem] bg-gradient-to-r from-[#58AFEF] to-[#9374DC]  justify-center'><button>Book now !</button></a>
                </div>
