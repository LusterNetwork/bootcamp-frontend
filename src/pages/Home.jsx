...
const Home = () => {
  ...
  const clickButtonSol =
    " border py-3 px-4 md:text-2xl font-semibold my-2 rounded-xl bg-gradient-to-r from-[#58AFEF] to-[#9374DC] mx-8";
  const unclickedButtonSol =
    "border py-3 px-4 rounded-xl font-semibold md:text-2xl my-2 hover:bg-gray-800 mx-8";
  ...
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2  mx-auto items-center md:pt-32 py-6 my-9 gap-5 min-h-[100vh] w-[75%]  md:p-4">
        <div className="col-span-1 mt-12 place-self-center md:w-[80%]">
          ...
          <p className="text-2xl my-8">
            We are on the mission to upskill 1M+ Web3 enthusiasts to Web3
            developers by 2025
          </p>
   ...
   bg-black hover:border-2 border-white rounded-md md:w-[70%] lg:w-[70%] xl:w-[70%] sm:w-[100%] "
        >
          <p className="text-center my-6 text-white text-4xl font-semibold">errorOcean</p>
          <p className="text-white ml-10 text-xl leading-10">Hey, are you looking for a solution to your wired errors...</p>
          <p className="text-white ml-10 text-xl leading-10">So, don't worry head over to the errorOcean</p>
          <p
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 py-2 md:pt-20 my-[7rem] gap-5 md:w-[85%] w-[90%] mx-auto">
        <div className="col-span-1">
          <p class="text-4xl md:text-7xl font-semibold mb-3">
            Perks of learning web3
          </p>
          <ul class="list-disc">
